Imports SPGeneral
Public Class ReportTop10Provider
        ...
        If Not UserLogin Is Nothing Then
            If Not Page.IsPostBack Then
                If UserLogin.IsActive Then
                    Try
                        Session("DashBoard") = "TOP 10 PROVIDER <i class='fa fa-star fa-fw'></i>"
                    ...
                    Catch ex As Exception
                        ...
                        Dim msg As String = String.Format("{0} - ReportTop10Provider - " & UserLogin.UserId & " - {1} - {2}{3}", Now.ToString("dd/MM/yyyy HH:mm:ss"), UserLogin.BranchCode, ex, Environment.NewLine)
                        WriteFile.Write(config.SetFullFilePath, msg)
                    End Try
                Else
                    Response.Redirect("login.aspx?p=ReportTop10Provider.aspx", False)
                End If
            End If
        Else
    ...
    Sub viewrpt(strform As String, key1 As String, key2 As String, key3 As String, key4 As String)
        Try
            ...
            Session("JudulXls") = "TOP_10_Provider"
