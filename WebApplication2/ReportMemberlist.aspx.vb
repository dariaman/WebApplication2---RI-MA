        ...
        If Not UserLogin Is Nothing Then
            If Not Page.IsPostBack Then
                If UserLogin.IsActive Then
                    Try
                        Session("DashBoard") = "MEMBER LIST <i class='fa fa-users fa-fw'></i>"
                    ...
                    Catch ex As Exception
                        ...
                        Dim msg As String = String.Format("{0} - ReportMemberList - " & UserLogin.UserId & " - {1} - {2}{3}", Now.ToString("dd/MM/yyyy HH:mm:ss"), UserLogin.BranchCode, ex, Environment.NewLine)
