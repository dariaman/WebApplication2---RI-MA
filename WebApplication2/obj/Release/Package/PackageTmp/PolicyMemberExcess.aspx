<%@ Page Title="Info | Info | Info Excess" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="PolicyMemberExcess.aspx.vb" Inherits="WebApplication.PolicyMemberExcess" %>
                            ...
                            <div class="panel-body">
                                <div class="dataTable_wrapper">
                                    ...
                                    <asp:GridView ID="GVVw_Claim_Info_Header" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" DataKeyNames="CLAIMNO" EmptyDataRowStyle-CssClass="empty_data" EmptyDataText="No data Found">
                                        <columns>
                                            <asp:TemplateField HeaderText="CLAIM NO" ItemStyle-ForeColor="#0000FF" ItemStyle-HorizontalAlign="Left" ControlStyle-CssClass="accordion-toggle" >
                                                <ItemTemplate>
        ...
        <div id="DivBody1">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header">
                            <h3 class="box-title">Excess Detail<small>&nbsp;INFORMATION</small></h3>
