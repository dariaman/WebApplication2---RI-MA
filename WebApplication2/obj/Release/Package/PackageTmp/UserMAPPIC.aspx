<%@ Page Title="File | Setting | PIC Provider MAP" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="UserMAPPIC.aspx.vb" Inherits="WebApplication.UserMAPPIC" %>
    ...
    <asp:Panel ID="pnlPopup" runat="server" Visible="false" DefaultButton="LinkSubmit">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <asp:TextBox ID="txtName" runat="server" onkeypress="return isKey(event)" data-toggle="tooltip" data-placement="top" title="Input User name" MaxLength="100" class="form-control" placeholder="User Name.." name="User Name.." type="User Name.." ReadOnly="True"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
        ...
        <div class="col-sm-6">
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group input-group">
                        <span class="input-group-addon">Provider Id <i class="fa fa-hospital-o fa-fw"></i></span>
                        <asp:TextBox ID="txtProvider" runat="server" data-toggle="tooltip" data-placement="top" title="Input Provider Id.." MaxLength="20" CssClass="form-control" placeholder="Provider Id.." name="Provider Id.." type="Provider Id.." onkeypress="return isKey(event)"></asp:TextBox>
                    </div>
                </div>
            </div>
            </div>
                    ...
                    <div style="overflow-y: scroll; height: 100px; padding-left: 5px;">
                        <asp:DataGrid ID="DGDetailLog" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="1" CssClass="table table-striped table-bordered table-hover" ItemStyle-HorizontalAlign="Left" Width="98%">
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="MEMBID" HeaderText="MEMBER ID"></asp:BoundColumn>
