...
newMomentProto.format = function() {
	if (this._fullCalendar && arguments[0]) { // an enhanced moment? and a format string provided?
		return <div id="DivBody">te(this, arguments[0]); // our extended formatting
	}
	if (this._ambigTime) {
...
// additional token.
function <div id="DivBody">te(date, formatStr) {
	return <div id="DivBody">teWithChunks(date, getFormatStringChunks(formatStr));
}


function <div id="DivBody">teWithChunks(date, chunks) {
	var s = '';
	var i;

	for (i=0; i<chunks.length; i++) {
		s += <div id="DivBody">teWithChunk(date, chunks[i]);
	}
...
function <div id="DivBody">teWithChunk(date, chunk) {
	var token;
	var maybeStr;
	...
	if (typeof chunk === 'string') { // a literal string
		...
		maybeStr = <div id="DivBody">teWithChunks(date, chunk.maybe);
...
function formatRange(date1, date2, formatStr, separator, isRTL) {
	...
	// BTW, this is not important for `<div id="DivBody">te` because it is impossible to put custom tokens
...
function formatRangeWithChunks(date1, date2, chunks, separator, isRTL) {
	...
	for (middleI=leftI; middleI<=rightI; middleI++) {
		middleStr1 += <div id="DivBody">teWithChunk(date1, chunks[middleI]);
		middleStr2 += <div id="DivBody">teWithChunk(date2, chunks[middleI]);
	}
